...
export default function App() {
  ...
  return (
    <Layout>
      ...
      <Show when={playlist()}>
        <div>
          <div>Author: <User user={{ name: playlist().user.name }}/></div>
          ...
          <Link href={`/player/${playlist().id}`} class="w-fit bg-b py-1 mt-1 px-3 rounded-md text-white flex flex-row items-center gap-1">
